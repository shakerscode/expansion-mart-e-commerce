        ...
        <header>
            ...
            <div className={`flex justify-between items-center md:px-14 px-3 md:py-4 py-2 h-16 md:h-auto ${open ? 'shadow-none' : 'shadow-md'} md:shadow-none`}>
                ...
                <div className='flex items-center gap-5 text-2xl text-center'>
                    ...
                    <button className='border-r border-gray pr-3 text-black hover:text-secondary transition-all ease-in-out duration-200 md:block hidden'><AiOutlineHeart /></button>
                    <button className='border-r border-gray pr-3 text-black hover:text-secondary transition-all ease-in-out duration-200 md:block hidden'><HiOutlineShoppingBag /></button>
                    <button className=' md:pr-3 text-black hover:text-secondary transition-all ease-in-out duration-200'><AiOutlineUser /> </button>
                </div>

            </div>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5 md:px-14 px-3 py-2'>
                <button
                    onMouseOver={handleHover}
                    className='flex justify-center items-center gap-4 md:text-xl font-semibold bg-primary md:w-52 w-full rounded-lg text-white px-4 py-2 hover:bg-secondary transition-all ease-in-out duration-300 relative'><BsJustifyLeft className='md:block hidden' /> All Categories</button>
            ...
            {
                show &&
                <div className='bg-white shadow-lg py-3 w-60 h-fit-content px-2 absolute left-14 md:top-[11.5rem] rounded-lg transition-transform ease-in duration-500 z-10'>
