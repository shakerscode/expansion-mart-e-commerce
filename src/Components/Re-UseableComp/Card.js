...
const Card = ({product}) => {
    return (
        ...
        className='px-3 py-2 hover:shadow-lg  rounded-lg transition-all duration-500 ease-in-out gap-4  bg-white shadow relative'>
        <img src={product?.image} alt="" className='md:h-44 h-40 mx-auto pb-2' />
