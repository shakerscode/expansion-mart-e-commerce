        ...
        <div className='h-[300px] md:w-full flex justify-center items-center mx-4'>
            <div className='md:w-[70%]  h-52 flex flex-col justify-center items-center bg-primary rounded-lg shadow-lg'>
                ...
                <div className='flex text-white relative '>
                    ...
                    <button className='flex justify-center items-center gap-2 absolute md:right-4 right-4 top-5 bottom-5 bg-secondary px-3 py-2 rounded-lg hover:bg-primary transition-all duration-500 ease-in-out hover:translate-x-1'><span className='md:block hidden'>Subscribe</span> <BsArrowRight/></button>
                </div>
            </div>
        </div>
    );
